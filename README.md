...
Semantic HTML is markup that means something. You can't just have random stuff and expect people to know what it's for so you have to make sense.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

block takes up the full width and inline only takes the space that it needs. inline respects height, width, margin and padding and block does not.
...
It allows for collaberation from remote areas.
